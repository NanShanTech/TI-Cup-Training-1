...
/*===========================================================================
 * 二、q15 FFT 频谱分析参数（实时链路）
 *===========================================================================*/
#define FFT_Q15_N               4096       /* q15 FFT 点数 (256/512/1024/2048/4096)  */
#define FFT_Q15_N_2             (FFT_Q15_N / 2)
#define FFT_Q15_SAMPLE_RATE     32000    /* ADC 采样率 (Hz)                        */
#define FFT_Q15_SCALE_SHIFT     3         /* 采样值左移位数，防 q15 精度丢失        */

/*===========================================================================
 * 三、f32 FFT 频谱分析参数（离线高精度）
 *===========================================================================*/
#define FFT_N               2048          /* FFT 点数（2 的幂）                     */
#define FFT_N_2             (FFT_N / 2)   /* 频谱有效点数                            */
#define FREQ_S              32000        /* ADC 采样率 (Hz)                        */
